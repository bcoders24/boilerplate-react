      ...
      >
        ...
        {localValues.map((value, index) => (
          <React.Fragment key={index}>
            ...
            <SliderPrimitive.Thumb className="block cursor-pointer h-4 w-4 rounded-full border border-primary/50 bg-background shadow transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50" />
          </React.Fragment>
        ))}
      </SliderPrimitive.Root>
    );
